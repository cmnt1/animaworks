...
class TestSandboxConfiguration:
    ...
    @pytest.mark.skipif(os.name == "nt", reason="Windows filenames cannot contain quotes or backslashes")
...
class TestACPProtocol:
    ...
    @pytest.mark.asyncio
    @pytest.mark.skipif(os.name == "nt", reason="pty/termios are POSIX-only")
