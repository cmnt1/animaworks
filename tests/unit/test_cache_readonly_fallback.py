...
CAN_TEST_POSIX_PERMISSIONS = hasattr(os, "geteuid") and os.geteuid() != 0
...
@pytest.mark.skipif(not CAN_TEST_POSIX_PERMISSIONS, reason="requires non-root POSIX permissions")
