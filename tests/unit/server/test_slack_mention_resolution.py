...
class TestResolveSlackMentions:
    ...
    def test_resolves_single_mention_via_api(self, mock_cls: MagicMock) -> None:
        ...
        out = resolve_slack_mentions("hey <@U123ABC>", "xoxb-token")
    ...
    def test_uses_cache_on_second_call(self, mock_cls: MagicMock) -> None:
        ...
        resolve_slack_mentions("hi <@U123ABC>", "tok")
    ...
    def test_resolves_multiple_mentions(self, mock_cls: MagicMock) -> None:
        ...
        out = resolve_slack_mentions("<@U111> said hi to <@U222>", "tok")
    ...
    def test_empty_token_still_converts_cached(self, mock_cls: MagicMock) -> None:
        ...
        user_name_cache.clear()
        user_name_cache["U123ABC"] = "CachedUser"
        out = resolve_slack_mentions("yo <@U123ABC>", "")
...
class TestBuildSlackAnnotation:
    """Tests for :func:`server.gateways.slack_socket._build_slack_annotation`."""
...
class TestDetectMentionIntent:
    """Tests for :func:`server.gateways.slack_socket._detect_mention_intent`."""

    def test_bot_mention_returns_question(self) -> None:
        from server.gateways.slack_socket import _detect_mention_intent
...
class TestLoadAliasUserIds:
    """Tests for :func:`server.gateways.slack_socket._load_alias_user_ids`."""

    @patch("server.gateways.slack_socket.load_config")
    def test_returns_slack_user_ids_from_config(self, mock_load: MagicMock) -> None:
        from server.gateways.slack_socket import _load_alias_user_ids
