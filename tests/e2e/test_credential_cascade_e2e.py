...
class TestSlackCredentialCascade:
    ...
    def test_config_json_resolution(self, config_dir, monkeypatch):
        ...
        with patch("core.integrations._slack_client._require_slack_sdk"):
            with patch("core.integrations._slack_client.WebClient") as mock_wc:
                client = SlackClient()
...
class TestXSearchCredentialCascade:
    ...
    def test_config_json_resolution(self, config_dir, monkeypatch):
        ...
        from core.integrations.x_search import XSearchClient
