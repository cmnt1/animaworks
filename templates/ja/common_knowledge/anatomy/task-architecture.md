...
## Layer 3: Anima ノート（state/current_state.md, state/pending.md）
...
| 読み取り | Anima 自身、Priming（current_state.md のみ） |

`current_state.md` は「今まさにやっていること」、`pending.md` は「やるべきことの自分用メモ」。
