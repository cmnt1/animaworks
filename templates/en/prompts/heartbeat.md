...
- Review your ledger with `animaworks-tool task board`. Close stale, duplicate, or obsolete tasks with `task claim ID` → `task cancel ID --reason REASON`. If you manage subordinates, use `--all` to review and coordinate the whole board.
