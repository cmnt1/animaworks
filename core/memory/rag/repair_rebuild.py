...
def atomic_rebuild_vectordb(
    ...
    *,
    ...
    try:
        ...
        # Collection presence alone is not enough: Chroma can list collections
        # while SQLite's FTS5 index is malformed, which trips startup
        # quick_check and re-enters supervised repair right after the swap.
