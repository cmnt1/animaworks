...
_SENTINEL = object()       # Queue termination marker for keep-alive merge
    ...
    async def _handle_process_message_stream(
        ...
        try:
            ...
            while True:
                ...
                if isinstance(item, IPCResponse) and (item.done or item.error):
                    break
        finally:
