...
from core.integrations._image_clients import _DOWNLOAD_TIMEOUT
...
def _download_armature_animation(
    ...
    from core.integrations.image_gen import _convert_fbx_to_glb as _cvt_fbx
    from core.integrations.image_gen import strip_mesh_from_glb as _strip_mesh
...
"""
    ...
    script_path = None
    try:
        from core.integrations.image_gen import _ensure_gltf_transform_modules
