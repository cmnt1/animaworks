...
from core.integrations._chatwork_cli import cli_main, get_cli_guide  # noqa: F401
from core.integrations._chatwork_client import ChatworkClient  # noqa: F401
from core.integrations._chatwork_identity import check_write_allowed, resolve_identity

# ── Re-exports (backward compatibility) ──────────────────────
from core.integrations._chatwork_markdown import clean_chatwork_tags, md_to_chatwork  # noqa: F401
...
def _sync_rooms(client: ChatworkClient, cache: MessageCache, sync_limit: int = 30) -> dict:
    ...
    from core.integrations._chatwork_cli import _sync_rooms as _do_sync
