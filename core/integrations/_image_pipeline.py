...
class ImageGenPipeline:
    ...
    def generate_bustup_expression(
        ...
        from core.integrations.image_gen import _build_reference_client
    ...
    def generate_all(
        ...
        """
        from core.integrations.image_gen import MeshyClient, _build_fullbody_client, _build_reference_client
